...
> [!NOTE]
> For information about the latest version of the C# language - version 7 - refer to the article [What's New in C# 7.0](https://docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-7)
